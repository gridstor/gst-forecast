import{d as _,$ as u,y as h,b as n,e as t,x as s,A as r,F as f,Z as g,o as l,a0 as v,l as x,g as b}from"../modules/vue-CLdSbzWw.js";import{u as y,h as N,c as m}from"../index-C1ojEdyF.js";import{_ as k}from"./NoteDisplay.vue_vue_type_style_index_0_lang-cq8m7wcf.js";import"../modules/shiki-DM7uYPJp.js";const w={id:"page-root"},L={class:"m-4"},T={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},H={class:"text-lg"},S={class:"font-bold flex gap-2"},$={class:"opacity-50"},A={key:0,class:"border-main mb-8"},z=_({__name:"print",setup(C){const{slides:d,total:p}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
